...
export const Hero: React.FC<HeroProps> = ({ onOpenQuote }) => {
  return (
    <section id="home" className="relative w-full overflow-hidden bg-white border-b border-slate-100 min-h-[440px] lg:min-h-[490px] flex items-center">
      ...
      {/* Desktop Right-Side Team Banner with Soft Feathered Fade Mask on the Left */}
      <div className="hidden lg:block absolute top-0 right-0 bottom-0 lg:w-[54%] xl:w-[55%] pointer-events-none z-0 overflow-hidden">
        ...
        <div className="absolute top-8 right-10 z-10 pointer-events-none text-right">
          <p className="script-font text-[40px] text-white font-bold leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.95)] rotate-[-4deg]">
            A Cleaner<br />
            Greener<br />
            Brighter<br />
            Tomorrow
        ...
        <div className="absolute bottom-8 right-10 z-10 flex items-center space-x-3.5 bg-[#0B1E33]/92 backdrop-blur-md py-2.5 px-4 rounded-2xl border border-slate-600/50 shadow-2xl">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-6 sm:py-7 lg:py-8">
        <div className="max-w-xl lg:max-w-[560px] xl:max-w-[620px] text-left space-y-3.5 sm:space-y-4">
          ...
          <div className="pt-0.5">
            <span className="text-[11px] sm:text-xs md:text-sm font-extrabold tracking-widest uppercase text-slate-500">
              CLEANER SPACES. GREENER TOMORROW.
            </span>
          </div>

          {/* Main Headline */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-[54px] font-black tracking-tight leading-[1.08] text-slate-900">
          ...
          <p className="text-base sm:text-lg lg:text-[22px] font-extrabold text-slate-900 leading-snug">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-1">
            <button
              onClick={onOpenQuote}
              className="inline-flex items-center justify-center space-x-2.5 bg-monarch-blue hover:bg-monarch-blue-800 text-white px-7 py-3 rounded-full font-bold text-sm sm:text-base shadow-lg shadow-monarch-blue/20 hover:shadow-xl transition-all transform hover:-translate-y-0.5 active:translate-y-0"
            >
            ...
            <a
              href="#services"
              className="inline-flex items-center justify-center bg-white hover:bg-slate-50 text-monarch-blue border-2 border-monarch-blue px-7 py-2.5 rounded-full font-bold text-sm sm:text-base transition-all hover:shadow-sm"
            >
              Our Services
            </a>
          </div>

          {/* Mobile Team Showcase Card (Shown only on < lg screens for crystal-clear readability) */}
          <div className="block lg:hidden pt-2 pb-1">
            <div className="relative rounded-2xl overflow-hidden shadow-md border border-slate-100 aspect-[16/10] sm:aspect-[2/1] w-full">
              <img
                src="/images/hero-team.jpg"
                alt="Monarch Services - Professional Property Care Team"
                ...
                loading="eager"
              />
              {/* Soft overlay gradient so script text and badge pop */}
              <div className="absolute inset-0 bg-gradient-to-t from-slate-900/60 via-transparent to-black/30 pointer-events-none" />

              {/* Script font text positioned properly over the team image */}
              <div className="absolute top-3.5 right-3.5 text-right pointer-events-none">
                <p className="script-font text-xl sm:text-2xl text-white font-bold leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.95)] rotate-[-3deg]">
                  A Cleaner<br />
                  Greener<br />
                  Brighter<br />
                  Tomorrow
              ...
              {/* Serving Homes & Businesses Badge */}
              <div className="absolute bottom-3 left-3 flex items-center space-x-2 bg-[#0B1E33]/92 backdrop-blur-md py-1.5 px-3 rounded-xl border border-slate-600/50 shadow-md">
                <div className="w-7 h-7 rounded-full border-[2px] border-[#4CAF50] flex items-center justify-center flex-shrink-0">
                  <svg viewBox="0 0 28 28" className="w-3.5 h-3.5" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path 
                      d="M23 4C14 4.5 6 12.5 6 22.5C16 22.5 24 14.5 24.5 5.5L23 4Z" 
                      fill="white"
                    />
                ...
                <div className="text-left leading-tight">
                  <span className="block text-[10px] sm:text-xs font-extrabold tracking-wider uppercase text-white">SERVING</span>
                  <span className="block text-[10px] sm:text-xs font-extrabold tracking-wider uppercase text-white">HOMES &amp; BUSINESSES</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="pt-4 sm:pt-6 border-t border-slate-200/80">
            <div className="grid grid-cols-2 gap-3 sm:flex sm:flex-wrap sm:items-center sm:gap-y-4 sm:gap-x-7 lg:gap-x-8">
              
              {/* 1. Reliable Service: Solid Blue Shield with White Checkmark */}
              <div className="flex items-center space-x-2 sm:space-x-2.5 flex-shrink-0">
                <svg viewBox="0 0 32 32" className="w-7 h-7 sm:w-9 sm:h-9 flex-shrink-0" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="text-left leading-tight">
                  ...
                  <span className="block text-[11px] sm:text-[13px] font-medium text-slate-700">Service</span>
                </div>
              </div>

              {/* 2. Professional Team: Solid Blue 3-Person Silhouettes */}
              <div className="flex items-center space-x-2 sm:space-x-2.5 flex-shrink-0">
                <svg viewBox="0 0 36 32" className="w-8 h-7 sm:w-10 sm:h-9 flex-shrink-0" fill="#003B95" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="text-left leading-tight">
                  ...
                  <span className="block text-[11px] sm:text-[13px] font-medium text-slate-700">Team</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2 sm:space-x-2.5 flex-shrink-0">
                ...
                <div className="text-left leading-tight">
                  ...
                  <span className="block text-[11px] sm:text-[13px] font-medium text-slate-700">Solutions</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-2 sm:space-x-2.5 flex-shrink-0">
                ...
                <div className="text-left leading-tight">
                  ...
                  <span className="block text-[11px] sm:text-[13px] font-medium text-slate-700">Customer Focused</span>
                </div>
              </div>
